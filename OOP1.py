...
# лекторы
lecturer_1 = Lecturer('Luylya', 'Kebab')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Imya', 'Familia')
lecturer_2.courses_attached += ['Java']

lecturer_3 = Lecturer('Tsar', 'Tsarevich')
...
cool_reviewer_2 = Reviewer('Never', 'Gonna')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Java']

# студенты
student_1 = Student('Give', 'You')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Up', 'Let')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Down', 'Around')
...
print(
    f'Результат сравнения студентов (по средним оценкам за ДЗ): 'f'{student_1.name} {student_1.surname} < {student_2.name} {student_2.surname} = {student_1 > student_2}')
print()

print(
    f'Результат сравнения лекторов (по средним оценкам за лекции): 'f'{lecturer_1.name} {lecturer_1.surname} < {lecturer_2.name} {lecturer_2.surname} = {lecturer_1 > lecturer_2}')
print()
